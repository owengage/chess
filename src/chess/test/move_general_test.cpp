...
namespace chess
{
    ...
    TEST_F(MoveGeneralFixture, cant_queen_side_castle_while_king_in_check)
    {
        auto b = Board::with_pieces({
                {"A1", wrook},
                {"E1", wking},
    ...
    TEST_F(MoveGeneralFixture, cant_queen_side_castle_through_targeted_square)
    {
        auto b = Board::with_pieces({
                {"A1", wrook},
                {"E1", wking},
                {"D8", brook} // can attack king 'through' castling
        });
        auto g = Game{driver, b};
    ...
    TEST_F(MoveGeneralFixture, cant_queen_side_castle_if_rook_has_moved)
    {
        auto b = Board::with_pieces({
                {"F7", bpawn},
                {"A1", wrook},
